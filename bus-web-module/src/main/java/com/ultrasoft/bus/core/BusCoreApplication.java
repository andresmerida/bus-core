package com.ultrasoft.bus.core;
...
public class BusCoreApplication {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(BusCoreApplication.class);

    public static void main(String[] args) {
        var springApplication = new SpringApplication(BusCoreApplication.class);
